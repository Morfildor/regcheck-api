...
CASES = (
    ...
    subtype_case(GROUP, "industrial_charger", "industrial battery charger for forklift packs", "industrial_charger", tags=("boundary",)),
    ...
    subtype_case(GROUP, "usb_charging_hub", "usb charging station with pd charger", "usb_charging_hub", tags=("boundary",)),
