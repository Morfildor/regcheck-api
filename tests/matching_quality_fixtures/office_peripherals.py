...
CASES = (
    ...
    subtype_case(GROUP, "document_camera_classroom", "document camera for classroom presentation", "document_camera", tags=("boundary",)),
    subtype_case(GROUP, "document_scanner_a4", "a4 document scanner with usb", "document_scanner", forbidden_subtypes=("office_printer",)),
    subtype_case(GROUP, "kvm_switch_dual_monitor", "kvm switch for dual monitor desktop setup", "kvm_switch", tags=("boundary",)),
