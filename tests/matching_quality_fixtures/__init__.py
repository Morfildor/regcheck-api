...
from .building_access_controls_wave6 import CASES as BUILDING_ACCESS_CONTROLS_WAVE6_CASES
...
from .lighting_optical_wave6 import CASES as LIGHTING_OPTICAL_WAVE6_CASES
...
from .office_peripherals_wave6 import CASES as OFFICE_PERIPHERALS_WAVE6_CASES
...
from .power_charging_wave6 import CASES as POWER_CHARGING_WAVE6_CASES
...
MATCHING_QUALITY_GROUPS: dict[str, tuple[MatchingQualityCase, ...]] = {
    ...
    "office_peripherals": OFFICE_PERIPHERALS_CASES + OFFICE_PERIPHERALS_WAVE4_CASES + OFFICE_PERIPHERALS_WAVE6_CASES,
    "networking": NETWORKING_CASES + NETWORKING_WAVE4_CASES,
    "security_access": SECURITY_ACCESS_CASES + SECURITY_ACCESS_WAVE4_CASES,
    "power_charging": POWER_CHARGING_CASES + POWER_CHARGING_WAVE4_CASES + POWER_CHARGING_WAVE6_CASES,
    "lighting_optical": LIGHTING_OPTICAL_CASES + LIGHTING_OPTICAL_WAVE4_CASES + LIGHTING_OPTICAL_WAVE6_CASES,
    "tools_machinery": TOOLS_MACHINERY_CASES,
    "ev_micromobility": EV_MICROMOBILITY_CASES,
    "wellness_boundary": WELLNESS_BOUNDARY_CASES + WELLNESS_BOUNDARY_WAVE4_CASES + WELLNESS_BOUNDARY_WAVE6_CASES,
    "specialty_boundary": SPECIALTY_BOUNDARY_CASES + SPECIALTY_BOUNDARY_WAVE4_CASES,
    "building_access_controls": BUILDING_ACCESS_CONTROLS_CASES + BUILDING_ACCESS_CONTROLS_WAVE6_CASES,
